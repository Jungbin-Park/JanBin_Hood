DROP USER bjproject CASCADE;

CREATE USER bjproject IDENTIFIED BY bjproject DEFAULT TABLESPACE users TEMPORARY TABLESPACE temp PROFILE DEFAULT;

GRANT CONNECT, RESOURCE TO bjproject ;
GRANT CREATE VIEW, CREATE SYNONYM TO bjproject;

ALTER USER bjproject ACCOUNT UNLOCK;

conn bjproject/bjproject;
