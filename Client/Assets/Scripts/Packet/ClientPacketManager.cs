...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.SReg, MakePacket<S_Reg>);
		_handler.Add((ushort)MsgId.SReg, PacketHandler.S_RegHandler);		
		_onRecv.Add((ushort)MsgId.SPortal, MakePacket<S_Portal>);
		_handler.Add((ushort)MsgId.SPortal, PacketHandler.S_PortalHandler);		
		_onRecv.Add((ushort)MsgId.SSkill, MakePacket<S_Skill>);
		_handler.Add((ushort)MsgId.SSkill, PacketHandler.S_SkillHandler);		
		_onRecv.Add((ushort)MsgId.SMyroomSave, MakePacket<S_MyroomSave>);
		_handler.Add((ushort)MsgId.SMyroomSave, PacketHandler.S_MyroomSaveHandler);		
		_onRecv.Add((ushort)MsgId.SMyroomLoad, MakePacket<S_MyroomLoad>);
		_handler.Add((ushort)MsgId.SMyroomLoad, PacketHandler.S_MyroomLoadHandler);		
